...
def greeting_intent(intent_request):
    ...
    intro = get_slots(intent_request)["Ready"]

def processInput(response_lex):    
...
def search_intent(labels):
    ...
    url = 'https://vpc-photos-jyfvd34cn3s2eu2vgwfj475hzy.us-east-1.es.amazonaws.com/photos/_search?q='
